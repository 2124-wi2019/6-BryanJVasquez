...
standardInput.on('data', function(text) {
    ...
    //The following console.log will execute if user types C or c//
    ...
    //The following console.log will execute if user types S or s//
    else if (text === "S" || "s") {
        clearScreen();
    ...
    //The following console.log will execute if user types T or t//
    else if (text === "T" || "t") {
        clearScreen();
    ...
    //If user doens't type any of the previous letters, the following console.log will execute//
    else {
        clearScreen();
